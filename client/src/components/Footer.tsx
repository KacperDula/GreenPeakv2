      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-poppins font-bold text-xl">GreenPeak Solutions</span>
            </Link>
            <p className="text-gray-300 mb-6 max-w-md">
              Helping businesses grow sustainably through expert consulting, digital transformation, 
              and strategic planning. Your partner in sustainable business growth.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} GreenPeak Solutions. All rights reserved.
          </p>
